...
##### The API design 
	...
	All controllers were designed to behave similarly to make integration with the front-end as smooth as possible and to be controlled by one unit. this way the module is going to be implemented to be   
decoupled and satisfies the single responsibility design rule.  **Look at figure 2**.
